...
<View style={{position: 'absolute', height: 30, width: 30, borderRadius: 15, backgroundColor: '#1b9cfc', right: 15, bottom: 15, alignItems: 'center',justifyContent: 'center', zIndex: 2000,}}>
